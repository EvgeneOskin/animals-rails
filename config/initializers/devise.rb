...
Devise.setup do |config|
  ...
  # `secret_key` by default. You can change it below and use your
  # own secret key.
  # config.secret_key = '61fe291d17b79b19165fc44a609c89d0014d9a8664495bcd0e8a'\
  #   '9a8c0de30f1a4cb0d9b01776467d5b212b52bf6a0c595ac3cd142cee6ad287975668e7'\
  #   '9985f3'
  ...
  # environments. Note that, for bcrypt (the default encryptor),
  ...
  # config.pepper = 'ec18988fc79eee17123a0520d02e69bfcea16a2b80665ac4d48f6df'\
  #   'f1878341e3dbc4a68cf69cd7de5385496f7db659dccaaeaa7d1469d5b451391089843'\
  #   '71b1'
  ...
  # Default is nil, meaning there is no restriction on how long a user
  # can take before confirming their account.
  # config.confirm_within = 3.days

  # If true, requires any email changes to be confirmed (exactly the same way
  # as initial account confirmation) to be applied.
  # Requires additional unconfirmed_email db field (see migrations).
  # Until confirmed, new email is stored in unconfirmed_email column, and
  ...
  # Time interval to unlock the account if :time is enabled
  #   as unlock_strategy.
